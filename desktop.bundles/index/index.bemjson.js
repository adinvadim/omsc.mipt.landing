                        ...
                        content : {
                            ...
                            content : [
                                ...
                                },
                                {
                                    ...
                                    content : `Первая в России онлайн-магистратура от одного из лучших вузов страны`,
                                },
                                {
                                    block : 'button',
            ...
            content : [
                {
                    ...
                    content : [{
                        ...
                        content : [
                            ...
                            {
                                tag : 'p',
                                content : `Физтех-первый в России среди ведущих вузов-приглашает  принять участие в онлайн-обучении по комбинаторике. Данная магистерская программа позволит создать прочный фундамент знаний современной дискретной математики и её приложений в информатике и при анализе сложных сетей. Однако подготовка студентов в рамках магистратуры не ограничивается только техническими предметами, взращивая специалистов, с одной стороны, обладающих фундаментальными знаниями, а с другой стороны, способных развиваться в разных направлениях.`
                            }
                        ]
                    }],
                }, /* row end */
                    ...
                    content : [{
                        ...
                        content : {
                            ...
                            content : `Студенты МФТИ, чаще всего, трудоустраиваются уже в процессе обучения.
                                Не является исключением и онлайн-магистратура. Основные области, в которых применимы полученные знания и навыки — IT сектор, страхование, банковская сфера. После прохождения данной магистратуры вы сможете работать в крупнейших компаниях: Сбербанк, Yandex, ABBYY и многих других.`
                        }
                    }]
                }, /* row end   */
