                ...
                }, /* row end */
                {
                    ...
                    content : [{
                        ...
                        content : {
                            tag : 'p',
                            content : [
                                'После успешной защиты квалификационной работы магистра выдается ',
                                {
                                    tag : 'b',
            ...
            content : [
                {
                    ...
                    content : [{
                        ...
                        },
                        {
                            tag : 'p',
                            content : [
                                'Обучение по программе ведется на платной основе.',
                            ]
                        }, {
                            tag : 'p',
                            ...
                            content : [
                                { tag : 'b', content : 'Шаг 2. ', },
                                'Подать заявление на обучение в магистратуре МФТИ.'
                            ]
                        }, {
                            tag : 'p',
                            content : [
